...
>(
  (
     ...
     * If the user presses enter, opens the popover.
     * If the user presses backspace and the input is empty, removes the last selected value.
    ...
    /**
     * Toggles the presence of an option in the selected values.
     * If the option is already present, it will be removed.
     * If the option is not present, it will be added.
     * After toggling the option, the onValueChange callback will be called
     * with the new selected values.
     * @param option The value of the option to toggle.
     */
